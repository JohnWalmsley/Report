...
\begin{figure}[hbt]
\begin{center}
\includegraphics[scale=0.42]{Figures/LASSO_SW_AP_full_lambda.png}
...
\begin{figure}[hb]
\begin{center}
\includegraphics[scale=0.42]{Figures/LASSO_SW_AP_core_lambda.png}
...
\begin{figure}[hb]
\begin{center}
\includegraphics[scale=0.42]{Figures/LASSO_EP_AP_full_lambda.png}
...
\label{Fig_LASSO_EP_AP_core_lambda}
\end{center}
\end{figure}
...
\begin{figure}[hb]
\begin{center}
\includegraphics[scale=0.42]{Figures/LASSO_MWDD_AP_full_lambda.png}
...
\label{Fig_LASSO_MWDD_AP_core_lambda}
\end{center}
\end{figure}
...
\begin{figure}[hb]
\begin{center}
\includegraphics[scale=0.42]{Figures/LASSO_OSW_AP_full_lambda.png}
